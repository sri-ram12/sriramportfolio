        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS & CI/CD</h3>
              <h4>Automating Infrastructure & Deployments</h4>
              <p>
                Building automated CI/CD pipelines and managing containerized
                applications. From infrastructure provisioning to monitoring,
                I deliver reliable DevOps workflows.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>AWS Cloud & Observability</h4>
              <p>
                Provisioning and managing cloud infrastructure on AWS.
